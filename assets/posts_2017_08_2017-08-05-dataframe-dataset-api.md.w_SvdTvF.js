...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#768390;">// +----+-----+</span></span></code></pre></div><hr><p>Links:</p><ol><li><a href="http://spark.apache.org/docs/latest/sql-programming-guide.html" target="_blank" rel="noreferrer">Spark SQL, DataFrames and Datasets Guide</a></li><li><a href="http://spark.apache.org/docs/latest/api/scala/index.html#org.apache.spark.sql.Dataset" target="_blank" rel="noreferrer">DataSet Api</a></li><li><a href="http://spark.apache.org/docs/latest/api/scala/index.html#org.apache.spark.sql.functions$" target="_blank" rel="noreferrer">DataFrame Functions</a></li></ol><hr><div style="text-align:center;color:#00000099;font-size:14px;">END</div>`,11),p=[t];function e(h,k,r,d,o,c){return i(),a("div",null,p)}const D=s(l,[["render",e]]);export{y as __pageData,D as default};
