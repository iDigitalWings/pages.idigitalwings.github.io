import{_ as a,a as i,af as n,o as p}from"./chunks/framework.C87LdZyP.js";const o=JSON.parse('{"title":"Nginx Upstream","description":"","frontmatter":{"title":"Nginx Upstream","date":"2017-11-08T00:00:00.000Z","tags":["nginx"],"category":["DevOps"]},"headers":[],"relativePath":"posts/2017/11/2017-11-08-nginx-upstream.md","filePath":"posts/2017/11/2017-11-08-nginx-upstream.md","lastUpdated":1718173059000}'),l={name:"posts/2017/11/2017-11-08-nginx-upstream.md"};function e(t,s,h,k,r,d){return p(),i("div",null,s[0]||(s[0]=[n(`<div class="language-perl vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">perl</span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#ADBAC7;">user  root;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#ADBAC7;">    }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#ADBAC7;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#ADBAC7;">}</span></span></code></pre></div>`,1)]))}const c=a(l,[["render",e]]);export{o as __pageData,c as default};
