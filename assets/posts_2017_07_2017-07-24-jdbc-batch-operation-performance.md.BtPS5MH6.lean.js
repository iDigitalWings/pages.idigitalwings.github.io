import{_ as i,a,af as n,o as t}from"./chunks/framework.C87LdZyP.js";const A=JSON.parse('{"title":"MySql JDBC batch operation performance","description":"","frontmatter":{"title":"MySql JDBC batch operation performance","date":"2017-07-24T00:00:00.000Z","tags":["mysql","jdbc"]},"headers":[],"relativePath":"posts/2017/07/2017-07-24-jdbc-batch-operation-performance.md","filePath":"posts/2017/07/2017-07-24-jdbc-batch-operation-performance.md","lastUpdated":1718193786000}'),p={name:"posts/2017/07/2017-07-24-jdbc-batch-operation-performance.md"};function l(e,s,h,k,r,d){return t(),a("div",null,s[0]||(s[0]=[n(`<p>对一个50多万行记录的表中更新数据,每次读取1000,根据主键id进行更新, 每次对1000条数据进行更新,测试平局消耗时间大概在18秒.</p><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#ADBAC7;">0000	 	 17363 finish</span></span>
