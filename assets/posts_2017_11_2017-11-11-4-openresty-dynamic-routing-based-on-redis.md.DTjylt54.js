import{_ as s,a as i,o as a,aj as n}from"./chunks/framework.Ba_Ek9Jm.js";const c=JSON.parse('{"title":"OpenResty: Dynamic Routing Based On Redis","description":"","frontmatter":{"title":"OpenResty: Dynamic Routing Based On Redis","date":"2017-11-11T00:00:00.000Z","tags":["ratelimite","nginx","openresty","lua"],"category":["DevOps"]},"headers":[],"relativePath":"posts/2017/11/2017-11-11-4-openresty-dynamic-routing-based-on-redis.md","filePath":"posts/2017/11/2017-11-11-4-openresty-dynamic-routing-based-on-redis.md","lastUpdated":1718173059000}'),l={name:"posts/2017/11/2017-11-11-4-openresty-dynamic-routing-based-on-redis.md"},p=n(`<p>来自官网例子，通过请求头里面的<code>User-Agent</code>把请求路由到不同的后端。</p><p>使用了 OpenResty 绑定的如下模块，</p><ul><li>Redis2 Nginx Module,</li><li>Lua Nginx Module,</li><li>Lua Redis Parser Library,</li><li>and Set Misc Nginx Module</li></ul><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#F69D50;">worker_processes</span><span style="--shiki-light:#005CC5;--shiki-dark:#6CB6FF;">  1</span><span style="--shiki-light:#24292E;--shiki-dark:#ADBAC7;">;</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F47067;">&lt;</span><span style="--shiki-light:#24292E;--shiki-dark:#ADBAC7;">nginx.org home page goes here</span><span style="--shiki-light:#D73A49;--shiki-dark:#F47067;">&gt;</span></span></code></pre></div><hr><ul><li><a href="http://openresty.org/cn/dynamic-routing-based-on-redis.html" target="_blank" rel="noreferrer">Dynamic Routing Based On Redis</a></li><li><a href="https://github.com/openresty/redis2-nginx-module#" target="_blank" rel="noreferrer">Github: redis2-nginx-module</a></li></ul><hr>`,13),e=[p];function t(h,k,r,F,d,g){return a(),i("div",null,e)}const o=s(l,[["render",t]]);export{c as __pageData,o as default};
