import{_ as a,a as n,af as i,o as t}from"./chunks/framework.C87LdZyP.js";const e="/assets/unsync-queue1.CL0xV9L_.png",p="/assets/unsync-queue2.BrYNfYaJ.png",u=JSON.parse('{"title":"RabbitMQ ha with Docker","description":"","frontmatter":{"title":"RabbitMQ ha with Docker","date":"2017-11-17T00:00:00.000Z","tags":["rabbitmq","docker","ha","cluster"],"category":["DevOps"]},"headers":[],"relativePath":"posts/2017/11/2017-11-17-2-rabbitmq-ha-with-docker.md","filePath":"posts/2017/11/2017-11-17-2-rabbitmq-ha-with-docker.md","lastUpdated":1718173059000}'),l={name:"posts/2017/11/2017-11-17-2-rabbitmq-ha-with-docker.md"};function r(o,s,h,c,d,b){return t(),n("div",null,s[0]||(s[0]=[i(`<h2 id="docker-compose-xml" tabindex="-1"><code>docker-compose.xml</code> <a class="header-anchor" href="#docker-compose-xml" aria-label="Permalink to &quot;\`docker-compose.xml\`&quot;">​</a></h2><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#8DDB8C;">version</span><span style="--shiki-light:#24292E;--shiki-dark:#ADBAC7;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#96D0FF;">&quot;2&quot;</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#96D0FF;">   &#39;{&quot;ha-mode&quot;:&quot;exactly&quot;,&quot;ha-params&quot;:2,&quot;ha-sync-mode&quot;:&quot;automatic&quot;}&#39;</span></span></code></pre></div><p>如果不自动同步，一个节点挂掉重启之后需要手动同步列队。</p><p>不然会造成消息丢失。</p><p><img src="`+e+'" alt=""></p><p><img src="'+p+'" alt=""></p><hr><ul><li><a href="https://www.rabbitmq.com/ha.html#eager-synchronisation" target="_blank" rel="noreferrer">Configuring Synchronisation</a></li><li><a href="http://josuelima.github.io/docker/rabbitmq/cluster/2017/04/19/setting-up-a-rabbitmq-cluster-on-docker.html" target="_blank" rel="noreferrer">Setting up a RabbitMQ Cluster on Docker</a></li></ul>',31)]))}const g=a(l,[["render",r]]);export{u as __pageData,g as default};
